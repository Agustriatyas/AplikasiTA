...
<body>
	...
	<div class="info" style="margin_buttom:10px">
		...
		<table id="dg" title="ENTRY DATA PERIZINAN" class="easyui-datagrid" style="height:250px" url="data_master/barang/get_barang.php" toolbar="#toolbar" pagination="true" rownumber="true" fitColumns="true" singleSelect="true">
			...
			<tbody>
				<?php $i = 1; ?>
				<?php foreach($entry_data_tinjauan as $p): ?>
				<tr>
				<?php
				...
				?>
					...
					<td><a href='<?php echo base_url() ?>index.php/back_office/entry_data_tinjauan/entry/<?php echo $p->id_perm ?>' ><img src='../../assets/img/doc_page.png'></a>
					<?php if($p->isdisable == 1): ?>
						<a href='<?php echo base_url() ?>index.php/back_office/entry_data_tinjauan/edit/<?php echo $p->id_perm ?>' ><img src='../../assets/img/property.png'></a>
					<?php endif ?>
