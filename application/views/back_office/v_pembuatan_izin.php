...
<body>
	...
	<div class="info" style="margin_buttom:10px">
		...
		<table id="dg" title="PEMBUATAN IZIN" class="easyui-datagrid" style="height:250px" url="data_master/barang/get_barang.php" toolbar="#toolbar" pagination="true" rownumber="true" fitColumns="true" singleSelect="true">
			<thead>
				<tr>
			...
			<tbody>
				...
				?>
					...
					<td>
						<a href='<?php echo base_url() ?>index.php/back_office/pembuatan_izin/cetak_sk/<?php echo $p->id_perm ?>' ><img src='../../assets/img/clipboard.png' title="Cetak SK"></a>
