					...
					<div class="tab-content">
						...
						<input type='text' name='id_perm' value='<?php echo $id_perm ?>'>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control npwp" name="tahun_lahir" id="tahun_lahir" onkeypress="validasi_npwp(event,this)" >
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<label class="col-sm-1 control-label">:</label>
								<div class="col-sm-3">
									<input type="text" class="form-control handphone" name="no_hak_milik" id="no_hak_milik" required/>
								</div>
							</div>
							<div class="form-group">
								...
								<label class="col-sm-1 control-label">:</label>
								<div class="col-sm-3">
									<input type="text" class="form-control phone" name="gsb" id="gsb" required/>
								</div>
							</div>
							<div class="form-group">
								...
								<label class="col-sm-1 control-label">:</label>
								<div class="col-sm-5">
									<input type="text" class="form-control" name="gsp" id="gsp" required/>
								</div>
							</div>
							<div class="form-group">
								...
								<label class="col-sm-1 control-label">:</label>
								<div class="col-sm-5">
									<input type="text" class="form-control" name="luas_bangunan_tutupan" id="luas_bangunan_tutupan" required/>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<label class="col-sm-1 control-label">:</label>
								<div class="col-sm-5">
									<input type="text" class="form-control" name="gss" id="gss" required/>
								</div>
							</div>
							<div class="form-group">
								...
								<label class="col-sm-1 control-label">:</label>
								<div class="col-sm-5">
									<input type="text" class="form-control" name="gsr" id="gsr" required/>
								</div>
							</div>
