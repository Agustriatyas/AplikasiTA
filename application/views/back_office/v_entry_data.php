...
<body>
	...
	<div class="info" style="margin_buttom:10px">
		...
		<table id="dg" title="ENTRY DATA PERIZINAN" class="easyui-datagrid" style="height:250px" url="data_master/barang/get_barang.php" toolbar="#toolbar" pagination="true" rownumber="true" fitColumns="true" singleSelect="true">
			<thead>
				<tr>
			...
			<tbody>
				...
				?>
					...
					<td>
					<a href='<?php echo base_url() ?>index.php/back_office/entry_data/entry/<?php echo $p->id_perm ?>' ><img src='../../assets/img/doc_page.png' alt="Buat type perumahan" title="Entry Data Perizinan" ></a>
					<?php if($p->isdisable == 1): ?>
						<a href='<?php echo base_url() ?>index.php/back_office/entry_data/edit/<?php echo $p->id_perm ?>' ><img src='../../assets/img/property.png' title="Ubah Data Perizinan" ></a>
					<?php endif ?>
					</td>
				</tr>
				<?php $i++; ?>
