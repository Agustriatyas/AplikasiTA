					...
					<div class="tab-content">
						<div class="tab-pane col-sm-12 active" id="a" style="padding-top:20px;">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control npwp" name="tahun_lahir" id="tahun_lahir" value="<?php echo($data_perizinan!='' ? $data_perizinan->thn_lahir : ''); ?>" onkeypress="validasi_npwp(event,this)" >
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<label class="col-sm-1 control-label">:</label>
								<div class="col-sm-5">
									<input type="text" class="form-control" name="luas_tanah" id="luas_tanah" value="<?php echo $data_perizinan->luas_tanah?>" required/>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<label class="col-sm-1 control-label">:</label>
								<div class="col-sm-3">
									<input type="text" class="form-control handphone" name="no_hak_milik" id="no_hak_milik" value="<?php echo $data_perizinan->no_hak_milik?>" required/>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<label class="col-sm-1 control-label">:</label>
								<div class="col-sm-5">
									<input type="text" class="form-control" name="gss" id="gss" value="<?php echo $data_perizinan->gss?>" required/>
								</div>
							</div>
							<div class="form-group">
								...
								<label class="col-sm-1 control-label">:</label>
								<div class="col-sm-5">
									<input type="text" class="form-control" name="gsr" id="gsr" value="<?php echo $data_perizinan->gsr?>" required/>
								</div>
							</div>
