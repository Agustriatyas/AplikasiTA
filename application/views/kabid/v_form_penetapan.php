<link rel="stylesheet" type="text/css" href="../../assets/jquery_easyui/themes/default/easyui.css">
	...
	<div class="row">
		<form class="form-horizontal" method="POST" role="form" data-toggle="validator" enctype="multipart/form-data" action="<?php echo base_url();?>index.php/kabid/penetapan_izin/save_penetapan">
			...
			<div class="col-xs-12">
				<div class="nav-tabs-custom col-sm-12 no-padding">
					<div class="tab-content">
						...
						<?php $i = 1; ?>
						<?php foreach($data_penetapan as $p): ?>
							<div>
							...
							<div>
								<label for="nama_lengkap" class="col-sm-2 control-label text-left-imp">Status Izin</label>
								<label class="col-sm-1 control-label">:</label>
								<form>
								  <input type="radio" name="status_izin" value="Diizinkan" <?php if ($p->status_izin == 'Diizinkan'): ?>checked<?php endif; ?>> Diizinkan<br>
								  <input type="radio" name="status_izin" value="Ditolak" <?php if ($p->status_izin == 'Ditolak'): ?>checked<?php endif; ?>> Ditolak<br><br/>
								</form>
							</div>
					<?php $i++; ?>
					<?php EndForeach; ?>
