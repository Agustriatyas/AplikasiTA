...
<body>
	...
	<div class="info" style="margin_buttom:10px">
		...
		<table id="dg" title="PENETAPAN IZIN" class="easyui-datagrid" style="height:250px" url="data_master/barang/get_barang.php" toolbar="#toolbar" pagination="true" rownumber="true" fitColumns="true" singleSelect="true">
			<thead>
				<tr>
			...
			<tbody>
				<?php $i = 1; ?>
				<?php foreach($penetapan_izin as $p): ?>
				<tr>
				<?php
				...
				?>
					...
					<td><a href='<?php echo base_url() ?>index.php/kabid/penetapan_izin/penetapan/<?php echo $p->id_perm ?>' ><img src='../../assets/img/doc_page.png' title="Penetapan Izin"></a>
					</td>
				</tr>
				<?php $i++; ?>
				<?php EndForeach; ?>
