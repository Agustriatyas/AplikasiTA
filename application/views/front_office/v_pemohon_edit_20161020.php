	...
	<div class="row">
      ...
      //                                   "Mendirikan, Memperluas & Memperbaiki"=>"Mendirikan, Memperluas & Memperbaiki",
	                    ...
	                    <?php if ($combo): ?> 
	                        <?php foreach ($combo as $row): ?> 
	                            <?php if ($row->jenis_permohonan == $jenis_izin->jenis_permohonan): ?> 
      ...
      //                                   "7"=>"Karyawan",
				...
				<div class="form-group">
					...
					<label class="col-sm-1 control-label">:</label>
					<div class="col-sm-5">
						<input type="text" class="form-control" name="jns_peruntukan" id="jns_peruntukan" required value="<?php echo($data_edit!='' ? $data_edit->peruntukan : ''); ?>"/>
					</div>
				</div>
					...
					<div class="tab-content">
						<div class="tab-pane col-sm-12 active" id="a" style="padding-top:20px;">
							...
							<div class="form-group">
								...
								<label class="col-sm-1 control-label">:</label>
								<div class="col-sm-5">
									<input type="text" class="form-control" name="no_referensi" id="no_referensi" required value="<?php echo($data_edit!='' ? $data_edit->no_identitas : ''); ?>"/>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control npwp" name="npwp_pemohon" id="npwp" onkeypress="validasi_npwp(event,this)" value="<?php echo($data_edit!='' ? $data_edit->npwp_pemohon : ''); ?>">
								</div>
							</div>
							<div class="form-group">
								...
								<label class="col-sm-1 control-label">:</label>
								<div class="col-sm-5">
									<input type="text" class="form-control" name="nama_lengkap" id="nama_lengkap" required value="<?php echo($data_edit!='' ? $data_edit->nama_lengkap : ''); ?>"/>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<label class="col-sm-1 control-label">:</label>
								<div class="col-sm-3">
									<input type="text" class="form-control phone" name="no_telp_pemohon" id="no_telp" required value="<?php echo($data_edit!='' ? $data_edit->telp_pemohon : ''); ?>"/>
								</div>
							</div>
							<div class="form-group">
								...
								<label class="col-sm-1 control-label">:</label>
								<div class="col-sm-5">
									<input type="text" class="form-control" name="email_pemohon" id="email" required value="<?php echo($data_edit!='' ? $data_edit->email : ''); ?>"/>
								</div>
							</div>
							<div class="form-group">
								...
								<label class="col-sm-1 control-label">:</label>
								<div class="col-sm-5">
									<textarea class="form-control" name="alamat_pemohon" id="alamat" rows="3" required value="<?php echo($data_edit!='' ? $data_edit->alamat : ''); ?>"></textarea>
								</div>
							</div>
							<div class="form-group">
						...
						<div class="tab-pane col-sm-12" id="b" style="padding-top:20px;">
							<div class="form-group">
								...
								<label class="col-sm-1 control-label">:</label>
								<div class="col-sm-5">
									<input type="text" class="form-control npwp" name="npwp_perusahaan" id="npwp_perusahaan" onkeypress="validasi_npwp(event,this)" required value="<?php echo($data_edit!='' ? $data_edit->npwp_perusahaan : ''); ?>"/>
								</div>
							</div>
							<div class="form-group">
								...
								<label class="col-sm-1 control-label">:</label>
								<div class="col-sm-5">
									<input type="text" class="form-control" name="n_perusahaan" id="n_perusahaan" required value="<?php echo($data_edit!='' ? $data_edit->nama_perusahaan : ''); ?>"/>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<label class="col-sm-1 control-label">:</label>
								<div class="col-sm-5">
									<input type="number" class="form-control uang" min="1" name="investasi" id="investasi" placeholder="" required value="<?php echo($data_edit!='' ? $data_edit->nilai_investasi : ''); ?>"/>
								</div>
							</div>
							<div class="form-group">
								...
								<label class="col-sm-1 control-label">:</label>
								<div class="col-sm-2">
									<input type="number" class="form-control" min="0" name="jumlah_tk" id="jumlah_tk"  value="<?php echo($data_edit!='' ? $data_edit->jumlah_tk : ''); ?>"/>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<label class="col-sm-1 control-label">:</label>
								<div class="col-sm-5">
									<input type="email" class="form-control" name="email_perusahaan" id="email"  required value="<?php echo($data_edit!='' ? $data_edit->email : ''); ?>"/>
								</div>
							</div>
							<div class="form-group">
								...
								<label class="col-sm-1 control-label">:</label>
								<div class="col-sm-5">
									<input type="text" class="form-control" name="website" id="webisite" value="<?php echo($data_edit!='' ? $data_edit->website : ''); ?>"/>
								</div>
							</div>
							<div class="form-group">
								<label for="nama_lengkap" class="col-sm-2 control-label text-left-imp">Alamat Lengkap</label>
								<label class="col-sm-1 control-label">:</label>
								<div class="col-sm-5">
									<textarea class="form-control" name="alamat_perusahaan" id="alamat_perusahaan" rows="3" required value="<?php echo($data_edit!='' ? $data_edit->alamat : ''); ?>"></textarea>
								</div>
							</div>
							<div class="form-group">
								<label for="provinsi" class="col-sm-2 control-label text-left-imp">Provinsi</label>
