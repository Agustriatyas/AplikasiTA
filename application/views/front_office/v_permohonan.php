...
<body>
	...
	<div class="info" style="margin_buttom:10px">
		...
		<table id="dg" title="DATA PERMOHONAN" class="easyui-datagrid" style="height:250px" url="data_master/barang/get_barang.php" toolbar="#toolbar" pagination="true" rownumber="true" fitColumns="true" singleSelect="true">
			<thead>
				<tr>
			...
			<tbody>
				...
				?>
					...
					<td><a href='<?php echo base_url() ?>index.php/front_office/pemohon/resi/<?php echo $p->id_perm ?>' ><img src='../../../assets/img/clipboard.png' title="Cetak Resi" ></a>
						<a href='<?php echo base_url() ?>index.php/front_office/pemohon/edit/<?php echo $p->id_perm ?>' ><img src='../../../assets/img/property.png' title="Ubah" ></a>
						<a href='<?php echo base_url() ?>index.php/front_office/pemohon/delete/<?php echo $p->id_perm ?>' onclick="return confirm('Anda yakin akan menghapusnya?');"><img src='../../../assets/img/cross.png' title="Hapus" ></a>
					</td>
				</tr>
				<?php $i++; ?>
				<?php EndForeach; ?>
