		...
		<form class="form-horizontal" method="POST" role="form" data-toggle="validator" enctype="multipart/form-data" action="<?php echo base_url();?>index.php/front_office/pemohon/insert">
			<div class="col-xs-12">
				<div class="form-group">
					<label for="nama_lengkap" class="col-sm-2 control-label">Jenis Permohonan</label>
					<label class="col-sm-1 control-label">:</label>
					<div>
						<select name="jenis_izin" id="jenis_izin" onchange="GetSyarat(this)" required>
							<option value=""></option>
				...
				<div class="form-group">
					<label for="nama_lengkap" class="col-sm-2 control-label">Jenis Peruntukan</label>
					<label class="col-sm-1 control-label">:</label>
					<div>
						<input type="text" name="jns_peruntukan" type="varchar" id="jns_peruntukan" required/>
					</div>
				</div>
				...
				<div class="nav-tabs-custom col-sm-12 no-padding">
					...
					<div class="tab-content">
						<div class="tab-pane col-sm-12 active" id="a" style="padding-top:20px;">
							<div class="form-group">
								<label for="nama_lengkap" class="col-sm-2 control-label text-left-imp" required="required">Jenis Identitas</label>
								<label class="col-sm-1 control-label">:</label>
								<div class="col-sm-2">
							...
							<div class="form-group">
								<label for="nama_lengkap" class="col-sm-2 control-label text-left-imp" required="required">Nomor Identitas</label>
								<label class="col-sm-1 control-label">:</label>
								<div class="col-sm-5">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="npwp" name="npwp_pemohon" id="npwp" onkeypress="validasi_npwp(event,this)" >
								</div>
							</div>
							<div class="form-group">
								<label for="nama_lengkap" class="col-sm-2 control-label text-left-imp" required="required">Nama Lengkap</label>
								<label class="col-sm-1 control-label">:</label>
								<div class="col-sm-5">
									<input type="text" name="nama_lengkap" id="nama_lengkap" required="required"/>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<label class="col-sm-1 control-label">:</label>
								<div class="col-sm-5">
									<input type="text" name="email_pemohon" id="email" required/>
								</div>
							</div>
							<div class="form-group">
								...
								<label class="col-sm-1 control-label">:</label>
								<div class="col-sm-5">
									<textarea name="alamat_pemohon" id="alamat" rows="3" required></textarea>
								</div>
							</div>
							<div class="form-group">
						...
						<div class="tab-pane col-sm-12" id="b" style="padding-top:20px;">
							<div class="form-group">
								...
								<label class="col-sm-1 control-label">:</label>
								<div class="col-sm-5">
									<input type="text" npwp" name="npwp_perusahaan" id="npwp_perusahaan" onkeypress="validasi_npwp(event,this)" required/>
								</div>
							</div>
							<div class="form-group">
								<label for="nama_lengkap" class="col-sm-2 control-label text-left-imp" required="required">Nama Perusahaan</label>
								<label class="col-sm-1 control-label">:</label>
								<div class="col-sm-5">
									<input type="text" name="n_perusahaan" id="n_perusahaan" required/>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<label class="col-sm-1 control-label">:</label>
								<div class="col-sm-5">
									<input type="number" class="uang" min="1" name="investasi" id="investasi" placeholder="" required/>
								</div>
							</div>
							<div class="form-group">
								...
								<label class="col-sm-1 control-label">:</label>
								<div class="col-sm-2">
									<input type="number" min="0" name="jumlah_tk" id="jumlah_tk"  />
								</div>
							</div>
							<div class="form-group">
								...
								<label class="col-sm-1 control-label">:</label>
								<div class="col-sm-5">
									<input type="text" class="phone" name="no_telp_perusahaan" id="no_telp_perusahaan" />
								</div>
							</div>
							<div class="form-group">
								<label for="nama_lengkap" class="col-sm-2 control-label text-left-imp">Email</label>
								<label class="col-sm-1 control-label">:</label>
								<div class="col-sm-5">
									<input type="email" name="email_perusahaan" id="email"  required/>
								</div>
							</div>
							<div class="form-group">
								...
								<label class="col-sm-1 control-label">:</label>
								<div class="col-sm-5">
									<input type="text" name="website" id="webisite" />
								</div>
							</div>
							<div class="form-group">
								<label for="nama_lengkap" class="col-sm-2 control-label text-left-imp">Alamat Lengkap</label>
								<label class="col-sm-1 control-label">:</label>
								<div class="col-sm-5">
									<textarea name="alamat_perusahaan" id="alamat_perusahaan" rows="3" required></textarea>
								</div>
							</div>
							<div class="form-group">
								<label for="provinsi" class="col-sm-2 control-label text-left-imp">Provinsi</label>
						...
						<div class="form-group">
							...
							<div class="form-group">
								...
								<label class="col-sm-1 control-label">:</label>
								<div class="col-sm-5">
									<textarea name="alamat_izin" id="alamat" rows="3" required></textarea>
								</div>
							</div>
						</div>
