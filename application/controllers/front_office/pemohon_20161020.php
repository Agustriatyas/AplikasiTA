<?php 
	class Pemohon extends CI_Controller{
		...
		function kabupaten($id_propinsi){
			...
			$html .= "<option></option>";
			foreach($data as $d){
				$html .= "<option value='".$d->id_kab."'>".$d->nama_kab."</option>";
			}
			echo $html;
		}
		...
		function kecamatan($id_kabupaten){
			...
			$html .= "<option></option>";
			foreach($data as $d){
				$html .= "<option value='".$d->id_kec."'>".$d->nama_kec."</option>";
			}
			echo $html;
		}
		...
		function kelurahan($id_kecamatan){
			...
			$html .= "<option></option>";
			foreach($data as $d){
				$html .= "<option value='".$d->id_kel."'>".$d->nama_kel."</option>";
			}
			echo $html;
		}
		...
		function insert(){
			...
			if($_POST){
				...
				redirect(base_url().'index.php/front_office/pemohon');
			}else{
				redirect('front_office/pemohon');
			}
		}
